...
**Headline:** Most Businesses Use Less Than 30% of Their Microsoft 365 Investment
...
- A personalized action plan to maximize your investment

**CTA Button:** Start My M365 Assessment
...
- [ ] Email, calendar, and shared calendars for team coordination
- [ ] Advanced features: rules, categories, shared mailboxes, scheduling assistant
...
- Advanced features: 20 points → **Power Platform Priority**
- Different system: 0 points → **Migration Priority**
...
- [ ] We use Microsoft Teams for some chats
- [ ] Teams is our primary communication hub (chat, calls, meetings)
...
- Teams is primary: 25 points → **SharePoint/OneDrive Priority**
- Other tools: 0 points → **Teams Priority**
...
- [ ] We use Teams meetings but just for basic video calls
- [ ] Teams meetings with recording, backgrounds, and breakout rooms
...
- Advanced Teams: 20 points → **SharePoint Priority**
- Teams + Events: 25 points → **Power Platform Priority**
...
- [ ] OneDrive + SharePoint for team collaboration
...
- OneDrive only: 15 points → **SharePoint Priority**
- OneDrive + SharePoint: 20 points → **Teams Priority**
- Full SharePoint: 25 points → **Power Platform Priority**
...
- [ ] We use real-time co-authoring in Word/Excel/PowerPoint
- [ ] Co-authoring + comments and @mentions for feedback
...
- Co-authoring + comments: 22 points → **SharePoint Priority**
- Full collaboration: 25 points → **Power Platform Priority**
...
- [ ] We have a decent folder structure on a shared drive
- [ ] Organized SharePoint sites with metadata and search
...
- SharePoint with metadata: 22 points → **Power Platform Priority**
- Advanced SharePoint: 25 points → **Security/Compliance Priority**
...
- [ ] Spreadsheets
- [ ] Third-party tools (Asana, Monday.com, Trello, etc.)
- [ ] Microsoft To Do or Planner for basic task lists
- [ ] Planner integrated with Teams for project management
...
- To Do/Planner basic: 18 points → **Planner Priority**
- Planner + Teams: 22 points → **Power Platform Priority**
- Microsoft Project: 25 points → **Power Platform Priority**
...
- [ ] We have some documented procedures, but execution is manual
- [ ] We use Power Automate for a few simple workflows
- [ ] Multiple Power Automate flows automating various processes
...
- Few workflows: 18 points → **Power Automate Priority**
- Multiple flows: 22 points → **Power Apps Priority**
- Power Platform: 25 points → **Advanced Analytics Priority**
...
- [ ] Email requests
- [ ] Google Forms or third-party survey tools
- [ ] Microsoft Forms for basic surveys
- [ ] Forms integrated with our systems (automatic data flow)
...
- Basic Forms: 18 points → **Power Automate Priority**
- Integrated Forms: 22 points → **Power Apps Priority**
- Power Apps: 25 points → **Advanced Analytics Priority**
...
- [ ] Different passwords, but no systematic approach
- [ ] Using a third-party password manager
- [ ] Some use of multi-factor authentication (MFA)
...
- Third-party manager: 12 points → **Security Priority**
- Some MFA: 18 points → **Security Priority**
- MFA enforced: 25 points → **Compliance Priority**
...
- [ ] Files are password-protected when needed
- [ ] We use SharePoint permissions to control access
- [ ] Sensitivity labels (Confidential, Internal, Public, etc.)
...
- SharePoint permissions: 18 points → **Security Priority**
- Sensitivity labels: 22 points → **Compliance Priority**
- Full DLP: 25 points → **Advanced Analytics Priority**
...
- [ ] We've had phishing or ransomware incidents
- [ ] Advanced threat protection for email
- [ ] ATP + security awareness training for staff
...
- Advanced protection: 18 points → **Security Priority**
- ATP + training: 22 points → **Compliance Priority**
- Full Defender: 25 points → **Advanced Analytics Priority**
...
- [ ] More advanced Excel (pivot tables, formulas)
- [ ] Power BI for some basic dashboards
- [ ] Regular Power BI reports shared across the team
...
- Basic Power BI: 20 points → **Power BI Priority**
- Regular reports: 22 points → **Power Platform Priority**
- Enterprise Power BI: 25 points → **AI/Copilot Priority**
...
- [ ] Review spreadsheets and email updates
- [ ] Access real-time dashboards occasionally
- [ ] Regular review of automated dashboards and KPIs
...
- Occasional dashboards: 18 points → **Power BI Priority**
- Regular KPI review: 22 points → **Power Platform Priority**
- AI insights: 25 points → **AI/Copilot Priority**
...
**Purpose:** Context for recommendations; doesn't affect scoring directly.
...
- Miscommunication → **Teams Priority**
- Reports/data → **Power BI Priority**
- Security → **Security Priority**

---

## **Scoring Logic & Category Assignment**

### **How Scoring Works**

Each question awards points based on current utilization level. The system calculates scores across six functional areas:

1. **Communication Score** (Q1-Q3): Max 75 points
2. **Collaboration Score** (Q4-Q6): Max 75 points
3. **Productivity Score** (Q7-Q9): Max 75 points
4. **Security Score** (Q10-Q12): Max 75 points
5. **Analytics Score** (Q13-Q14): Max 50 points
6. **Overall M365 Utilization**: Average of all areas

### **Priority Module Assignment**

The quiz assigns a **Primary Focus Module** based on the LOWEST scoring area (biggest gap/opportunity):

---

## **Result Categories**

### **Category 1: Teams & Communication Priority**

**Triggered when:** Communication Score is lowest (Q1-Q3 average < 13)

**Result Page Headline:** Your Priority: Transform Team Communication with Microsoft Teams

**Subheadline:** You're losing valuable time to scattered communication. Microsoft Teams can centralize everything.
...
- **@Mentions:** Get someone's attention without email overload
...
- **Week 4:** Add files and integrate apps into channels

**ROI Estimate:**
Teams typically save 4-6 hours per employee per week by reducing email volume and meeting setup time.
...
### **Category 2: SharePoint & File Management Priority**

**Triggered when:** Collaboration Score is lowest (Q4-Q6 average < 13)

**Result Page Headline:** Your Priority: Organize & Secure Your Files with SharePoint & OneDrive

**Subheadline:** Your team is wasting time hunting for files. SharePoint and OneDrive can create order from chaos.
...
- **Version History:** Restore previous versions if something goes wrong
...
- **Week 4:** Implement permissions, train on version history

**ROI Estimate:**
Proper file management saves 2-3 hours per employee per week searching for and managing documents.
...
### **Category 3: Power Automate & Process Automation Priority**

**Triggered when:** Productivity Score is lowest (Q7-Q9 average < 13)

**Result Page Headline:** Your Priority: Eliminate Repetitive Work with Power Automate

**Subheadline:** Your team is doing too much manual work. Power Automate can give you hours back every week.
...
- **Notifications:** Stay informed without checking manually
...
4. **Document Generation:** Create PDFs, contracts, or reports automatically
...
- **Week 4:** Connect workflows to Teams for visibility

**ROI Estimate:**
Process automation typically saves 5-10 hours per week across a small team.
...
### **Category 4: Planner & Task Management Priority**

**Triggered when:** Q7 scores low (< 15) and overall Productivity Score is moderate

**Result Page Headline:** Your Priority: Get Organized with Microsoft Planner & To Do

**Subheadline:** Tasks are falling through the cracks. Planner and To Do can bring clarity and accountability.
...
- **Progress Tracking:** Charts show completion status
...
- **Week 4:** Connect To Do for personal task management

**ROI Estimate:**
Better task management prevents dropped balls and reduces status meeting time by 30-40%.
...
### **Category 5: Security & Compliance Priority**

**Triggered when:** Security Score is lowest (Q10-Q12 average < 15)

**Result Page Headline:** Your Priority: Lock Down Your Data with M365 Security

**Subheadline:** Your business is at risk. M365's built-in security tools can protect you—but they need to be configured.
...
- **Conditional Access:** Control who can access what, from where
...
- **Week 4:** Set up DLP policies + security training
...
### **Category 6: Power BI & Analytics Priority**

**Triggered when:** Analytics Score is lowest (Q13-Q14 average < 13)

**Result Page Headline:** Your Priority: Make Better Decisions with Power BI

**Subheadline:** You're flying blind without data. Power BI can give you the insights you need to grow strategically.
...
- **Mobile Insights:** Check metrics from your phone
...
- **Week 4:** Set up automated refresh and distribution

**ROI Estimate:**
Better data visibility improves decision-making efficiency by 30-50% and can identify 5-10% cost savings.
...
### **Category 7: Microsoft 365 Foundations Priority**

**Triggered when:** Overall scores are very low across all categories (<40% average)

**Result Page Headline:** Your Priority: Build a Strong M365 Foundation

**Subheadline:** You're barely scratching the surface of M365. Let's build a solid foundation before going advanced.
...
- You may be using third-party tools for things M365 can do

**What This Means:**
You have massive opportunity ahead. Rather than jumping to advanced features, let's focus on getting the fundamentals right first.
...
**ROI Estimate:**
Proper M365 implementation saves 6-10 hours per employee per week through improved collaboration and reduced tool-switching.
...
### **Category 8: Advanced M365 Optimization Priority**

**Triggered when:** Overall scores are high across all categories (>80% average)

**Result Page Headline:** You're a Microsoft 365 Power User!

**Subheadline:** Your team is using M365 effectively. Let's explore cutting-edge features to stay ahead.
...
1. **Microsoft Copilot**
   - AI-powered assistance in all M365 apps
   - Automated meeting summaries and action items
   - Content generation and data analysis

2. **Advanced Power Platform**
   - Custom Power Apps for unique workflows
   - RPA (Robotic Process Automation) with Power Automate Desktop
   - AI Builder for intelligent automation

3. **Microsoft Viva**
   - Employee experience platform
   - Learning and knowledge management
   - Insights and analytics on work patterns

4. **Advanced Analytics**
   - Power BI embedded apps
   - Azure integration for big data

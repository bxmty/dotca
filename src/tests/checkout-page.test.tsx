...
describe('CheckoutPage Component', () => {
  ...
  it('shows credit card fields when credit card payment method is selected', async () => {
    ...
    expect(screen.getByText(/You'll receive an invoice via email./i)).toBeInTheDocument();
  ...
  it('submits the form with correct data', async () => {
    ...
    fireEvent.change(screen.getByLabelText('Expiration Date'), { target: { value: '12/25' } });

...
describe('stripe.ts utility', () => {
  ...
  describe('getStripe', () => {
    ...
    it('throws an error when publishable key is not set', () => {
      ...
      expect(() => getStripe()).toThrow('Stripe publishable key is not set in environment variables');
  ...
  describe('getServerStripe', () => {
    ...
    it('throws an error when secret key is not set', async () => {
      ...
      await expect(getServerStripe()).rejects.toThrow('STRIPE_SECRET_KEY is not set in environment variables');

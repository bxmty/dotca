  ...
  const customDocument = {
    ...
    querySelector: jest.fn((selector) => {
      ...
      if (selector === 'meta[name="viewport"]') {
        return {
          getAttribute: jest.fn((attr) => {
            if (attr === 'content') return 'width=device-width, initial-scale=1';
            return null;
          }),
          hasAttribute: jest.fn((attr) => {
            return attr === 'content';
          ...
          toHaveAttribute: jest.fn((attr, value) => {
            if (attr === 'content' && value === 'width=device-width, initial-scale=1') return true;
            return false;
          })
        };
      }
...
describe('RootLayout Component', () => {
  ...
  it('sets correct HTML attributes', () => {
    ...
    expect(document.querySelector('html')).toHaveAttribute('data-bs-theme', 'auto');
  });

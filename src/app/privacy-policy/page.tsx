export default function PrivacyPolicy() {
  return (
    <div className="container py-5">
      ...
      <p className="mb-4">
        At boximity msp, we respect your privacy and are committed to protecting your personal data.
      ...
      <p className="mb-4">
        ...
        phone number, and company information when you register or submit forms on our website.
      </p>
      ...
      <p className="mb-4">
        ...
        and comply with legal obligations. We do not sell or rent your personal information to third parties.
      </p>
      ...
      <h2 className="h4 mb-3">5. Third-Party Services</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        the new privacy policy on this page and updating the date at the top.
      </p>
      
      <h2 className="h4 mb-3">8. Contact Us</h2>
      <p className="mb-4">
        If you have any questions about this privacy policy, please contact us at privacy@boximity.com.
      </p>
    </div>
  );
}
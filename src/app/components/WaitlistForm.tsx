    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (responseData && responseData.error) {
          ...
          throw new Error(
            `Failed to join waitlist (Status: ${response.status})`,
          );
        }
      }
      ...
      setSubmitStatus({
        type: "success",
        message:
          "Thank you! You have been added to our waitlist. We'll contact you when services are available in your area.",
      });
      ...
      <div className="bg-dark text-white p-4 rounded mb-4">
        <div className="d-flex align-items-center mb-3">
          ...
          <div>
            ...
            <p className="text-light mb-0 small">
              Be the first to know when our services are available
            </p>
          </div>
        </div>
        ...
        <div className="mb-4 bg-secondary bg-opacity-25 p-3 rounded border border-secondary">
          ...
          <p className="mb-0 text-light">
            <strong>Team size:</strong> {employeeCount} employees
          </p>
        </div>
